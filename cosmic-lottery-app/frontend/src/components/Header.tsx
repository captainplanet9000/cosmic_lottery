        ...
        <header className="bg-slate-900 text-white p-4 shadow-lg sticky top-0 z-50">
            <nav className="container mx-auto flex flex-wrap justify-between items-center">
                ...
                >
                    ...
                    {/* Icon: Menu (hamburger) or Close (X) */}
                    {isMobileMenuOpen ? (
                ...
                <ul className="hidden md:flex md:items-center md:space-x-6 text-sm">
                    ...
                    <li><Link href="/generate-report" className="hover:text-purple-400 transition-colors py-1">Generate Report</Link></li>
                    <li><Link href="/my-reports" className="hover:text-purple-400 transition-colors py-1">My Reports</Link></li>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden mt-3" id="mobile-menu">
                    <ul className="flex flex-col space-y-3 px-2 pt-2 pb-3 bg-slate-800 rounded-md">
                        ...
                        <li><Link href="/generate-report" className="block hover:text-purple-400 transition-colors py-2 px-3 rounded-md hover:bg-slate-700" onClick={toggleMobileMenu}>Generate Report</Link></li>
                        <li><Link href="/my-reports" className="block hover:text-purple-400 transition-colors py-2 px-3 rounded-md hover:bg-slate-700" onClick={toggleMobileMenu}>My Reports</Link></li>
